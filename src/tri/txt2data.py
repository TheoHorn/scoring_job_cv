...
keywords = ["summary", "skills", "experience", "education", "accomplishments", "projects", "certifications", "languages", "interests", "publications"]
...
for i in range(len(df)):
    ...
    for j, (key, start, end) in enumerate(keyword_positions):
        ...
        if key in resume_dict:
            resume_dict[key].extend(filtered_tokens)
        else:
